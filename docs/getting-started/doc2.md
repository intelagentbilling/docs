...
![Example banner](./assets/designee_maintenance.png)


#### Click "Add Designee":

![Example banner](./assets/add_designee.png)


#### Enter the Designee Details (Full Name: IntelAGENT, Email: agent@intelagent.ca) and Click Save:

![Example banner](./assets/designee_details.png)


#### Click "Confirm this Designation"

![Example banner](./assets/confirm_designation.png)
